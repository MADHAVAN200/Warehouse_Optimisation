        ...
        <div className="min-h-screen bg-[#0a0a0a] text-foreground pb-20">
            ...
            <div className="sticky top-0 z-20 bg-[#0a0a0a]/95 backdrop-blur-md border-b border-[#222] px-6 py-4 shadow-md">
                <div className="flex flex-wrap items-center gap-4">
                    ...
                    <div className="flex flex-col space-y-1.5">
                        <label className="text-xs font-medium text-gray-500 uppercase">Forecast Horizon</label>
                    ...
                    <div className="flex flex-col space-y-1.5">
                        <label className="text-xs font-medium text-gray-500 uppercase">Impact Focus</label>
            ...
            <div className="p-6 max-w-7xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <Card className="bg-[#111] border-[#333]">
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-gray-400">Weather Severity</CardTitle>
                        </CardHeader>
                        <CardContent>
                            ...
                            <p className="mt-2 text-xs text-gray-500">Upcoming rainstorm (Thu)</p>
                        </CardContent>
                    </Card>

                    <Card className="bg-[#111] border-[#333]">
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-gray-400">Demand Sensitivity</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="flex items-center space-x-2">
                            ...
                            <p className="mt-2 text-xs text-gray-500">Staples & Delivery impacted</p>
                        </CardContent>
                    </Card>

                    <Card className="bg-[#111] border-[#333]">
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-gray-400">Spoilage Risk</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="flex items-center space-x-2">
                            ...
                            <p className="mt-2 text-xs text-gray-500">Temp within safe range</p>
                        </CardContent>
                    </Card>

                    <Card className="bg-[#111] border-[#333]">
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-gray-400">Logistics Risk</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="flex items-center space-x-2">
                            ...
                            <p className="mt-2 text-xs text-gray-500">Slight last-mile delays expected</p>
                        </CardContent>
                    </Card>
                </div>
                ...
                <Card className="bg-[#111] border-[#333]">
                    <CardHeader>
                        ...
                        <CardDescription className="text-gray-500">7-Day forecast for {selectedCity}</CardDescription>
                    </CardHeader>
                    <CardContent>
                            ...
                            {WEATHER_FORECAST.map((day, i) => {
                                ...
                                return (
                                    <div key={i} className={`flex flex-col items-center p-3 rounded-lg border ${day.condition.includes('Rain') || day.condition.includes('Storm') ? 'bg-blue-900/10 border-blue-800/30' : 'bg-[#1a1a1a] border-[#333]'
                                        ...
                                        <span className="text-xs text-gray-500 mb-1">{day.date}</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <Card className="lg:col-span-2 bg-[#111] border-[#333]">
                        <CardHeader>
                            ...
                            <CardDescription className="text-gray-500">Projected uplift/drop due to conditions.</CardDescription>
                        </CardHeader>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <Card className="bg-[#111] border-[#333]">
                        <CardHeader>
                            ...
                            <CardDescription className="text-gray-500">Inventory requiring attention.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Table>
                                <TableHeader>
                                ...
                                <TableBody>
                                    {RISK_SKUS.map((item, i) => (
                                        <TableRow key={i} className="border-[#222] hover:bg-[#1a1a1a]">
                                            ...
                                            <TableCell className="text-gray-400 text-xs">{item.advice}</TableCell>
                                        </TableRow>
                                    ))}
                                </TableBody>
                            </Table>
