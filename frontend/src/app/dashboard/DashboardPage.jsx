...
import {
  ...
  TrendingDown, TrendingUp, Truck, Users, Zap, ArrowRightLeft, LogOut, Eye
} from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-[#0a0a0a] text-foreground font-sans selection:bg-blue-500/30">
      ...
      <aside className="w-16 md:w-64 bg-[#111] border-r border-[#222] flex flex-col hidden md:flex sticky top-0 h-screen overflow-y-auto">
        ...
        <nav className="flex-1 py-4 space-y-2 px-2">
          ...
          <Button variant="ghost" className="w-full justify-start text-green-400 hover:text-green-300 hover:bg-[#222]" onClick={() => navigate('/control-tower/store-health')}>
            <Store className="w-5 h-5 mr-3" />
            <span className="hidden md:block">Store Health</span>
          </Button>
          <Button variant="ghost" className="w-full justify-start text-purple-400 hover:text-purple-300 hover:bg-[#222]" onClick={() => navigate('/control-tower/checkout-vision')}>
            <Eye className="w-5 h-5 mr-3" />
            <span className="hidden md:block">Checkout Vision</span>
          </Button>
          {role === 'admin' && (
        ...
        <main className="p-6 max-w-[1600px] mx-auto space-y-8 w-full">
          ...
          <section>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              {/* Stores at Risk */}
              <Card className="bg-[#111] border-[#333] cursor-pointer hover:border-red-500/50 transition-colors" onClick={() => navigate('/control-tower/store-health')}>
                <CardContent className="p-5">
                  <div className="flex justify-between items-start mb-2">
              ...
              {/* Critical Inventory */}
              <Card className="bg-[#111] border-[#333] cursor-pointer hover:border-yellow-500/50 transition-colors" onClick={() => navigate('/control-tower/inventory-risk')}>
                <CardContent className="p-5">
                  <div className="flex justify-between items-start mb-2">
              ...
              {/* Checkout Alerts */}
              <Card className="bg-[#111] border-[#333] cursor-pointer hover:border-blue-500/50 transition-colors" onClick={() => navigate('/control-tower/live-checkout')}>
                <CardContent className="p-5">
                  <div className="flex justify-between items-start mb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <Card className="bg-[#111] border-[#333] hover:border-blue-500/30 transition-colors group cursor-pointer h-[200px] flex flex-col" onClick={() => navigate('/control-tower/forecast-engine')}>
              ...
              <Card className="bg-[#111] border-[#333] hover:border-yellow-500/30 transition-colors group cursor-pointer h-[200px] flex flex-col" onClick={() => navigate('/control-tower/inventory-risk')}>
                <CardHeader className="pb-2">
              ...
              <Card className="bg-[#111] border-[#333] hover:border-blue-500/30 transition-colors group cursor-pointer h-[200px] flex flex-col" onClick={() => navigate('/control-tower/store-health')}>
                <CardHeader className="pb-2">
                  <CardTitle className="text-base font-semibold text-white group-hover:text-blue-400 transition-colors flex items-center justify-between">
            ...
            <div className="space-y-4">
              ...
              <Card className="bg-[#111] border-[#333] hover:border-purple-500/30 transition-colors group cursor-pointer h-[200px] flex flex-col" onClick={() => navigate('/control-tower/live-checkout')}>
                <CardHeader className="pb-2">
              ...
              <Card className="bg-[#111] border-[#333] hover:border-blue-500/30 transition-colors group cursor-pointer h-[200px] flex flex-col" onClick={() => navigate('/control-tower/checkout-vision')}>
                <CardHeader className="pb-2">
                  <CardTitle className="text-base font-semibold text-white group-hover:text-blue-400 transition-colors flex items-center justify-between">
                    Recent Issues
                    <ArrowRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" />
            ...
            <div className="space-y-4">
              ...
              <Card className="bg-[#111] border-[#333] hover:border-red-500/50 transition-colors group cursor-pointer h-[416px] flex flex-col" onClick={() => navigate('/control-tower/alerts')}>
              ...
              <Card className="bg-[#111] border-[#333] h-[200px] flex flex-col">
                ...
                <CardContent className="space-y-4 flex-1 flex flex-col justify-center">
                  <div className="flex items-center justify-between cursor-pointer hover:bg-[#1a1a1a] p-1 rounded" onClick={() => navigate('/control-tower/model-health')}>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex items-center justify-between cursor-pointer hover:bg-[#1a1a1a] p-1 rounded" onClick={() => navigate('/control-tower/federated-learning')}>
                    <div className="flex items-center gap-2">
