                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="bg-[#151515] border border-[#222]">
                            ...
                            <CardContent className="pb-4">
                                ...
                                <Button variant="link" size="sm" className="w-full text-xs text-blue-400 mt-2 h-6 p-0" onClick={() => navigate('/control-tower/store-health' + (fromControlTower ? '?from=control-tower' : ''))}>
