      ...
      <aside className="w-64 bg-[#111] border-r border-[#222] hidden md:flex flex-col fixed inset-y-0 z-20">
        ...
        <div className="p-4 border-t border-[#222]">
          {role === 'admin' && (
            <Button
              variant="ghost"
              className="w-full justify-start text-gray-400 hover:text-white hover:bg-[#222]"
              onClick={() => navigate('/dashboard')}
            >
              <Store className="w-5 h-5 mr-3" />
              <span className="hidden md:block">Staff Dashboard</span>
            </Button>
          )}
          {role === 'admin' && (
            <Button
          ...
          <Button variant="outline" className="w-full justify-start text-gray-400 border-[#333] hover:bg-[#222] hover:text-white bg-transparent" onClick={signOut}>
