...
export const knowledgeBase = [
    ...
    },
    {
        ...
        actions: [{ label: 'Detailed Forecast', route: '/control-tower/forecast-engine' }]
    },
    {
        ...
        actions: [{ label: 'View Inventory Risk', route: '/control-tower/inventory-risk' }]
    },
    {
        ...
        actions: [{ label: 'Live Monitoring', route: '/control-tower/live-checkout' }]
    },
    {
        id: 'dashboard-alerts',
        ...
        actions: [{ label: 'View All Alerts', route: '/control-tower/alerts' }]
    },
    ...
    },
    {
        ...
        actions: [{ label: 'Event Intelligence', route: '/control-tower/event-intelligence' }]
    },
    {
        ...
        actions: [{ label: 'Scenario Planning', route: '/control-tower/scenario-planning' }]
    },
    {
    ...
    },
    {
        ...
        actions: [{ label: 'Model Health', route: '/control-tower/model-health' }]
    },
    ...
    // --- INVENTORY RISK COMPONENTS ---
    {
        ...
        actions: [{ label: 'View Matrix', route: '/control-tower/inventory-risk' }]
    },
    {
    ...
    },
    {
        ...
        actions: [{ label: 'View Queue', route: '/control-tower/inventory-risk' }]
    },
    ...
    // --- EVENT INTELLIGENCE ---
    {
        ...
        actions: [{ label: 'Event Dashboard', route: '/control-tower/event-intelligence' }]
    },
    {
        ...
        actions: [{ label: 'View Marathon Details', route: '/control-tower/event-intelligence' }]
    },
    {
        ...
        actions: [{ label: 'View Festival Details', route: '/control-tower/event-intelligence' }]
    },
    {
        ...
        actions: [{ label: 'View Parade Details', route: '/control-tower/event-intelligence' }]
    },
    {
        ...
        actions: [{ label: 'View Chart', route: '/control-tower/event-intelligence' }]
    },
    {
        id: 'event-insights',
        ...
        actions: [{ label: 'View Insights', route: '/control-tower/event-intelligence' }]
    },
    ...
    // --- TREND INTELLIGENCE ---
    {
        ...
        actions: [{ label: 'Trend Dashboard', route: '/control-tower/trend-intelligence' }]
    },
    {
        id: 'trend-heatmap',
        ...
        actions: [{ label: 'View Heatmap', route: '/control-tower/trend-intelligence' }]
    },
    {
        id: 'trend-drivers',
        ...
        actions: [{ label: 'View Drivers', route: '/control-tower/trend-intelligence' }]
    },
    ...
    // --- WEATHER INTELLIGENCE ---
    {
        ...
        actions: [{ label: 'Weather Dashboard', route: '/control-tower/weather-intelligence' }]
    },
    {
        ...
        actions: [{ label: 'View Forecast', route: '/control-tower/weather-intelligence' }]
    },
    {
        ...
        actions: [{ label: 'View Risks', route: '/control-tower/weather-intelligence' }]
    },
    {
        ...
        actions: [{ label: 'View Advisories', route: '/control-tower/weather-intelligence' }]
    },
    ...
    // --- DEMAND FORECAST ENGINE ---
    {
        ...
        actions: [{ label: 'Forecast Engine', route: '/control-tower/forecast-engine' }]
    },
    {
        id: 'forecast-graph',
        ...
        actions: [{ label: 'View Graph', route: '/control-tower/forecast-engine' }]
    },
    {
        id: 'forecast-drivers',
        ...
        actions: [{ label: 'View Drivers', route: '/control-tower/forecast-engine' }]
    },
    {
        id: 'forecast-table',
        ...
        actions: [{ label: 'View Table', route: '/control-tower/forecast-engine' }]
    },
    ...
    },
    {
        ...
        actions: [{ label: 'Start Rebalancing', route: '/control-tower/stock-rebalancing' }]
    }
];
